<?php
require_once("1_cambiarEstadoBodega.php");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    <div class="container my-5">
      <div class="row">
        <table id="bodegaInactivos" class="table table-striped" style="width: 100%">
          <thead>
            <tr>         
                                        <th>ID</th>
                                        <th>NOMBRE</th>
                                        ...
                                        <th>CIUDAD</th>
                                        <th>DIRECCION</th>
						      <th id="bodegaInactivos_opciones">OPCIONES</th>
            </tr>
          </thead>
      ...
      <div class="footer">
        <div id="botonera" name="botonera">
            <table class="botonera">
              <tr>
                <th>
                  <div><button class="botons" onclick="imprimirBodega()">Imprimir</button></div>
                </th>
                <th>
                  <div><button class="botons" onclick="loadPageBodegaActivos()">Bodegas Activas</button></div>
                </th>
