...
<html lang="en">
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="http://localhost/Proyecto%20Final/MIPF/css/styleProveInactivos.css">
  ...
  <body>
    ...
    <div class="container my-5">
      <div class="row">
        <table id="proveInactivos" class="table table-striped" style="width: 100%">
          <thead>
            <tr>         
                                        <th>ID</th>
                                        <th>NOMBRE</th>
                                        ...
                                        <th>CIUDAD</th>
                                        <th>DIRECCION</th>
						      <th id="proveInactivos_opciones">OPCIONES</th>
            </tr>
          </thead>
        ...
        <div id="botonera" name="botonera">
            <table class="botonera">
              <tr>
                ...
                <th>
                  <div><button class="botons" onclick="loadPageProveActivos()">Proveedores Activos</button></div>
                </th>
