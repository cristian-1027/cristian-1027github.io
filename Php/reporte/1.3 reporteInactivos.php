...
<html lang="en">
  ...
  <body>
    ...
    <div class="container my-5">
      <div class="row">
        <table id="reporteInactivosJF" class="table table-striped" style="width: 100%">
          <thead>
            <tr>         
												<th>#</th>
												<th>ID</th>
        ...
        <div id="botonera" name="botonera">
            <table class="botonera">
              <tr>
                ...
                <th>
                  <div><button class="botons" onclick="loadPageReporteActivos()">Reportes Activos</button></div>
                </th>
