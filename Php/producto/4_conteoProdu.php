<?php
//require_once("4.1_conteoProdu.php");
   ...
   <body >
        ...
        <div class="container">
            ...
            <div class="register">
                ...
                <form action="4.1_conteoProdu.php" method="post" target="mainframe" >
                   <table id="Reporte" class="tabla" > 
                    ...
                    <tr>
                        ...
                        <td><input type="number" placeholder="Cantidad" name="stockEnc" id="stockEnc" required></td>
                    ...
                    <tr>
                        <td colspan="4"><textarea name="observacion" id="observacion" cols="40" rows="7" required></textarea></td>
                    </tr>
                                                                            
                    </table>
                    <br>
        <Button class="submit" type="submit" name="bt1">CREAR REPORTE</Button>
