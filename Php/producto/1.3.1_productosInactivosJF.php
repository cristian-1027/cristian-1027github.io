<?php
require_once("1_cambiarEstadoProdu.php");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="http://localhost/Proyecto%20Final/MIPF/css/styleProduActivos.css">
  ...
  <body>
    ...
    <div class="container my-5">
      <div class="row">
        <table id="produActivosJF" class="table table-striped" style="width: 100%">
          <thead>
            <tr>         
                                        <th>ID</th>
                                        <th>NOMBRE</th>
                                        ...
                                        <th>PROVEEDOR</th>
                                        <th>BODEGA</th> 
						      <th id="produActivos_opciones">OPCIONES</th>
            </tr>
          </thead>
      ...
      <div class="footer">
        <div id="botonera" name="botonera">
            <table class="botonera">
              <tr>
                <th>
                  <div><button class="botons" onclick="imprimirProductos()">Imprimir</button></div>
                </th>
                <th>
                  <div><button class="botons" onclick="loadPageProduInativos()">Productos Inactivos</button></div>
                </th>
                <th>
                  <div><button class="botons" onclick="crearProducto()">Crear Producto</button></div>
                </th>
              </tr>
            </table>
        </div>
