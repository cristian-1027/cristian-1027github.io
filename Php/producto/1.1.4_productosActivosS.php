...
<html lang="en">
  ...
  <body>
    ...
    <div class="container my-5">
      <div class="row">
        <table id="produActivosS" class="table table-striped" style="width: 100%">
          <thead>
            <tr>         
                                        <th>ID</th>
                                        <th>NOMBRE</th>
                                        ...
                                        <th>PROVEEDOR</th>
                                        <th>BODEGA</th> 
                                        <th id="produActivosS_opciones">OPCIONES</th>
            </tr>
          </thead>
      ...
      <div class="footer">
        <div id="botonera" name="botonera">
            <table class="botonera">
              <tr>
                <th>
                  <div><button class="botons" onclick="loadPageProduInativosS()">Productos Inactivos</button></div>
                </th>
