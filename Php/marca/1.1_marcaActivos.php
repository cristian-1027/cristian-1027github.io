...
<html lang="en">
  ...
  <body>
    ...
    <div class="container my-5">
      <div class="row">
        <table id="marca" class="table table-striped" style="width: 100%">
          <thead>
            <tr>         
                                        <th>ID</th>
                                        <th>NOMBRE</th>
                                        <th id="marca_opciones">OPCIONES</th>
            </tr>
          </thead>
        ...
        <div id="botonera" name="botonera">
            <table class="botonera">
              <tr>
                ...
                <th>
                  <div><button class="botons" onclick="crearMarca()">Crear Marca</button></div>
                </th>
              </tr>
            </table>
        </div>
