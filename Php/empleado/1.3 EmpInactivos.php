...
<!--
  <h1>Ferreteria Central Vale</h1>h
  <h2>NIT:24.852.268-1</h2>
  <h2>Cel:310.394.7287</h2>
  <h2>PALESTINA-CALDAS</h2>
  <h2>CORREGIMIENTO DE ARAUCA</h2>
  <h2>Cra 4 # 9 - 14</h2>
-->
        ...
        <table id="EmpInactivos" class="table table-striped" style="width: 100%">
          ...
          <thead>
            <tr>         
												...
												<!--<th id="EmpInactivos_opciones">OPCIONES</th>-->
            </tr>
          </thead>
      ...
      <div id="footer" class="footer">
        <div id="botonera" name="botonera">
            <table class="botonera">
                <tr>
                    <th>
                        <div><button class="botons" onclick="loadPageEmpActivos()">Empleados Activos</button></div>
                    </th>
