...
<html lang="en">
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="http://localhost/Proyecto%20Final/MIPF/css/styleEmp.css">
  ...
  <body>
    ...
    <div class="container my-5">
      <div class="row">
        <table id="EmpActivos" class="table table-striped" style="width: 100%">
          <thead>
            <tr>         
												<th>CEDULA</th>
												<th>NOMBRE </th>
                        ...
                        <th id="EmpActivosS_opciones">OPCIONES</th>
            </tr>
          </thead>
        ...
        <div id="botonera" name="botonera">
            <table class="botonera">
              <tr>
                ...
                <th>
                  <div><button class="botons" onclick="loadPageEmpInativosS()">Empleados Inactivos</button></div>
                </th>
                <th>
                  <div><button class="botons" onclick="crearEmpleado()">Registrar Empleado</button></div>
                </th>
