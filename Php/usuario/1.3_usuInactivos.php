...
<html lang="en">
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="http://localhost/Proyecto%20Final/MIPF/css/styleUsuInactivos.css">
  ...
  <body>
    ...
    <div class="container my-5">
      <div class="row">
        <table id="usuInactivos" class="table table-striped" style="width: 100%">
          <thead>
            <tr>         
                                ...
                                <th id="usuInactivos_opciones">OPCIONES</th>
            </tr>
          </thead>
        ...
        <div id="botonera" name="botonera">
            <table class="botonera">
              <tr>
                ...
                <th>
                  <div><button class="botons" onclick="loadPageUsuActivos()">Usuarios Activos</button></div>
                </th>
